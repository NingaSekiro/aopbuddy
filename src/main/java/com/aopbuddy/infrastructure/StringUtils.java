...
public abstract class StringUtils {
    ...
    public static String toCompleteMethodName(String methodAccess, String className, String methodName) {
        return methodAccess + "|" + className + "|" + methodName;
    }
}
